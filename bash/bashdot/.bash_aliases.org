...
#+BEGIN_SRC shell :tangle /home/dotfiles/bash/bashdot/.bash_aliases
alias ,='clear && timew'
alias ,s-start='clear && timew :adjust start'
alias ,o-stop='clear && timew :adjust stop'
alias ,c-continue='clear && timew :adjust continue'
alias ,m-summary='clear && timew summary :ids'
alias ,n-cancel='clear && timew cancel'
alias ,t-cheat='clear && cat ~/.timewarrior/thh'
alias ,r-remove-database='clear && mv -f ~/.timewarrior/data/2019* ~/.timewarrior/data.back &>/dev/null'
alias ,d-delete='timew delete'
alias ,h-help='clear && timew help'
alias ,e-shorten='timew shorten'
alias ,l-lenghten='timew lengthen'
#+END_SRC
* emacs
#+BEGIN_SRC shell :tangle /home/dotfiles/bash/bashdot/.bash_aliases
alias nn='emacs -nw'
...
alias ds='du --summarize --human-readable ./* | sort --human-numeric-sort --stable --reverse | bat ---color always'
