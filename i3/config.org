...
exec exec "~/scripts/emacs_scripts/live"
...
# bindsym $mod+Return exec st -e tmux attach
bindsym $mod+q kill
...
bindsym $mod+Control+p focus output Left
bindsym $mod+Control+n focus output Right

bindsym $mod+Control+F1 exec "pactl set-card-profile 0 output:hdmi-stereo"
bindsym $mod+Control+F2 exec "pactl set-card-profile 0 output:analog-stereo"
