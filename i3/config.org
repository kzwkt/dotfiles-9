...
for_window [title="term-right"] resize set 1000 1013; move to position 0 0
bindsym $mod+o exec ~/scripts/i3_scripts/hide/term_right_hide_others ; [title="term-right"] scratchpad show; move to position 960 22
